...
async function OnWinNo() {
	...
	let winningSpot = result.spot;
	let data = { room_id: timeStamp, game_id:5,winNo1:winNo[0],winNo2:winNo[1],spot:winningSpot }
...
//---------------------------------------------------------------------------------------------
	    if (totalLeftBets === totalMiddleBets && totalMiddleBets === totalRightBets) {
	        leastBetSpot = Math.floor(Math.random() * 10);//caculate random no form 0 to 2
